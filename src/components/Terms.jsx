    ...
    <div className='terms-body'>
      <div class='container'>
        ...
        <p>
          ...
          OlyOli's Website, located at olyoli.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions.
          Do not continue to use olyoli if you do not agree to take all of the terms
        ...
        <p>
          ...
          law of in. Any use of the above terminology or other words in the singular,
        ...
        <p>
          We employ the use of cookies. By accessing olyoli, you agreed to use
          cookies in agreement with the OlyOli's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, OlyOli and/or its licensors own the intellectual
          property rights for all material on olyoli. All intellectual property
          rights are reserved. You may access this from olyoli for your own personal
          use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul style={{ listStylePosition: "inside" }}>
          <li>Republish material from olyoli</li>
          <li>Sell, rent or sub-license material from olyoli</li>
        ...
        <p>
          ...
          opinions and information in certain areas of the website. OlyOli does not
          filter, edit, publish or review Comments prior to their presence on the
          website. Comments do not reflect the views and opinions of OlyOli,its
          ...
          applicable laws, OlyOli shall not be liable for the Comments or for any
        ...
        <p>
          OlyOli reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant OlyOli a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          compensates the absence of OlyOli; and (d) the link is in the context of
        ...
        <p>
          ...
          e-mail to OlyOli. Please include your name, your organization name, contact
        ...
        <p>
          No use of OlyOli's logo or other artwork will be allowed for linking absent
